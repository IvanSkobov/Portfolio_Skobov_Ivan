...
Начинающий backend-разработчик на Python с фокусом на FastAPI/Django/Flask. Есть опыт в создании телеграм-ботов, небольших веб‑сервисов и утилит. Люблю аккуратные UI, автоматизацию и чистый код. Открыт к стажировке и джун‑позициям.
  ...
  <tr>
    ...
    <td align="center" style="padding: 8px;">
      ...
      <a href="https://zerocoder.ru">
        <img src="static/images/certificates/python_chatgpt_cert.jpg" alt="Программист на Python с нуля с помощью ChatGPT" width="220"><br>
        Программист на Python с нуля с помощью ChatGPT
      </a>
      
      <br><sub>Университет Зерокодинга Zerocoder</sub>
      <br><sub>2025-11-02</sub>
    </td>
    ...
    <td align="center" style="padding: 8px;">
      ...
      <a href="https://zerocoder.ru">
        <img src="static/images/certificates/team_dev_outstanding.jpg" alt="Сертификат участника — Выдающееся участие в командной разработке" width="220"><br>
        Сертификат участника — Выдающееся участие в командной разработке
      </a>
      
      <br><sub>Университет Zerocoder</sub>
      <br><sub>2024</sub>
    </td>
    ...
    <td align="center" style="padding: 8px;">
      ...
      <a href="https://zerocoder.ru">
        <img src="static/images/certificates/team_dev_success.jpg" alt="Сертификат участника — Успешное участие в командной разработке" width="220"><br>
